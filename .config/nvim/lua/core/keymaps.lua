...
-- Buffer navigation
map("n", "gn", "<CMD>tabnext<CR>", { desc = "Next Buffer" })
map("n", "gp", "<CMD>tabprevious<CR>", { desc = "Prev Buffer" })
...
map("t", "<C-_><Esc>", "<C-\\><C-n>", { desc = "Escape insert mode on terminal", noremap = true })
