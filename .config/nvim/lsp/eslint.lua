...
return {
    ...
    root_dir           = function (bufnr, on_dir)
        ...
        root_file_patterns = utils.insert_package_json(root_file_patterns, "eslintConfig", fname)
    ...
    before_init        = function (_, config)
        ...
        if root_dir then
            ...
            for _, file in ipairs(flat_config_files) do
                if vim.fn.filereadable(utils.path(root_dir, file)) == 1 then
            ...
            local pnp_cjs = utils.path(root_dir, ".pnp.cjs")
            local pnp_js = utils.path(root_dir, ".pnp.js")
