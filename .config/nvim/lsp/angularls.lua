...
local function get_probe_dir()
    return project_root and (utils.path(project_root, "node_modules")) or ""
end
...
local function get_angular_core_version()
    ...
    local package_json = utils.path(project_root, "package.json")
...
return {
    ...
    filetypes    = { "html", "htmlangular", "typescript", "typescript.tsx" },
